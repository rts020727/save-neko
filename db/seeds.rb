...
shops = Shop.create!(
  [
    ...
    {email: 'campanynyanz@test.com', name: 'カンパニーにゃおう', password: 'ownerpassword', address: '宮城県富谷市ひより台１−４３−１９', phone_number: '000-9823-2982', opening: '11:00〜20:00', closed: 'なし', image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/shop24.jpg"), filename:"shop24.jpg") },
