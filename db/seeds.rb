...
Photo.create!(
  [
    ...
    { shop_id: rand(1..28), 
      ...
      image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/photo32.jpg"), filename:"photo33.jpg") },
    { shop_id: rand(1..28), 
      title: 'いたずらっこ', 
      content: "いたずら発見！\nすぐにコップにおててをつっこんじゃうつなちゃんでした。", 
      image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/photo33.jpg"), filename:"photo34.jpg") },
    { shop_id: rand(1..28), 
      title: 'おひるね', 
      content: "おててをぎゅっとして、寝ています。\n寝姿が可愛すぎます。", 
      image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/photo34.jpg"), filename:"photo35.jpg") },
    { shop_id: rand(1..28), 
      title: 'まんまる', 
      content: "キャットタワーでまん丸になって寝ていました。\n苦しくないのかな？", 
      image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/photo35.jpg"), filename:"photo36.jpg") }
  ]
)
